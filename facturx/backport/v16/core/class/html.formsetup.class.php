...
class FormSetupItem
{
	...
	public function generateInputFieldHtml()
	{
		...
		if(floatval(DOL_VERSION) > 18.0) {
			$width = 0;
		}
		$doleditor = new \DolEditor($this->confKey, $this->fieldValue, $width, 160, 'dolibarr_notes', '', false, $uselocalbrowser, isModEnabled('fckeditor'), ROWS_5, '90%');
