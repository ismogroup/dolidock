...
require_once __DIR__.'/backports.lib.php';
...
function AdminPrepareHead()
{
	...
	/*
	$head[$h][0] = dol_buildpath("/facturx/admin/myobject_extrafields.php", 1);
	...
	*/
	...
	$head[$h][0] = dol_buildpath("/facturx/admin/support.php", 1);
	...
	//    'entity:-tabname:Title:@facturx:/facturx/mypage.php?id=__ID__'
	//); // to remove a tab
	complete_head_from_modules($conf, $langs, null, $head, $h, 'facturx');
